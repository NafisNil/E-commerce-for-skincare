...
<section class="shop-main container d-flex pt-4 pt-xl-5 ">
    <div class="shop-sidebar side-sticky bg-body login" id="shopFilter">
    ...
    <div class="shop-list flex-grow-1 login">
            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="details.html"><img loading="lazy" src="{{(!empty($item->logo))?URL::to('storage/'.$item->logo):URL::to('image/no_image.png')}}" width="330"
                          height="400" alt="Cropped Faux leather Jacket" class="pc__img"></a>
                    </div>
                    @foreach (explode(',',$item->images)  as $key => $value) 
                     <div class="swiper-slide">
                        <a href="details.html"><img loading="lazy" src="{{(!empty($value))?URL::to('storage/'.$value):URL::to('image/no_image.png')}}"
              ...
              <div class="pc__info position-relative">
                <p class="pc__category">{{ @$item->category->name }} . {{ @$item->subCategory->name }}</p>
                <h6 class="pc__title"><a href="details.html">{{ $item->name }}</a></h6>
                <div class="product-card__price d-flex">
                  <span class="money price">
                    @if ($item->sales_price != null)
                    {{$item->sales_price}} BDT  &nbsp; <s>{{$item->regular_price}} BDT</s>
                    @else
                    {{$item->regular_price}} BDT  </s>
                    @endif
