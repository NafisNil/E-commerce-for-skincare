          ...
          <!-- left column -->
             <div class="card">
              <div class="card-header">
                ...
                <a href="{{route('brands.create')}}" class="float-right btn btn-outline-dark btn-sm mb-2"><i class="fas fa-plus-square"></i></a>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="{{route('brands.edit',[$item])}}" title="Edit">
                        ...
                        <form id="delete-form-{{ $item->id }}" action="{{route('brands.destroy',[$item])}}" method="POST" style="display:none;">
                          @method('DELETE')
                          @csrf
                        </form>
                      </td>
